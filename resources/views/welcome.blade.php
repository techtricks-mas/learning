...
<html lang="en">
  <head>
    ...
    <title>Elearning - Tutor, Education</title>
  </head>
  <body>
    ...
    <section class="slider-banner p-0">
      <div class="slider-carousel owl-carousel">
        <div class="slide slide-3" style="background-image: url({{ url('/') }}/assets/images/slider/3.jpg);"></div>
        <div class="slide slide-1" style="background-image: url({{ url('/') }}/assets/images/slider/2.jpg);"></div>
        <div class="slide slide-2" style="background-image: url({{ url('/') }}/assets/images/slider/1.jpg);"></div>
      </div>
      <div class="container">
    ...
    <section class="trial-sec">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 col-md-6 offset-lg-1">
            <form action="#" class="form trial-form bg-light" name="form">
